					...
					<div class="row vertical-tabs">
						<div class="col-sm-5">
							...
							<ul class="nav" role="tablist">
								<li class="active"> <a href="#vertical-tab1" role="tab" data-toggle="tab">At vero eos et accusam?</a> </li>
								<li> <a href="#vertical-tab2" role="tab" data-toggle="tab">Justo duo dolores et ea rebum?</a> </li>
								<li> <a href="#vertical-tab3" role="tab" data-toggle="tab">Stet clita kasd gubergren?</a> </li>
								<li> <a href="#vertical-tab4" role="tab" data-toggle="tab">No sea takimata sanctus est?</a> </li>
								<li> <a href="#vertical-tab5" role="tab" data-toggle="tab">At vero eos et accusam?</a> </li>
								<li> <a href="#vertical-tab6" role="tab" data-toggle="tab">Justo duo dolores et ea rebum?</a> </li>
								<li> <a href="#vertical-tab7" role="tab" data-toggle="tab">Stet clita kasd gubergren?</a> </li>
								<li> <a href="#vertical-tab8" role="tab" data-toggle="tab">No sea takimata sanctus est?</a> </li>
							</ul>
						</div>
						<div class="col-sm-7">
							<!-- Tab panes -->
