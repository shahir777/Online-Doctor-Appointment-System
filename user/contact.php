							...
							<form method="post" action="contactInsert.php">
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<input type="number" style="border:none;" maxlength="10" size="30" name="phone" placeholder="Phone Number" required>											</div>
									</div>
									<div class="col-sm-6">
										<div class="inbox">
										<!--<label for="email">Email address<span class="required">*</span></label>--> 
										&nbsp <i class="fa fa-envelope highlight2" aria-hidden="true"></i> 
										<input type="email" style="border:none;" size="30"  name="email" placeholder="Email Address" required>											</div>
									</div>
									<div class="col-sm-6">
										<div style="border:1px solid #ddd;">
										<!--<label for="subject">Subject<span class="required">*</span></label>-->
										&nbsp <i class="fa fa-flag highlight2" aria-hidden="true"></i> 
										<input type="text" size="30" style="border:none;" name="subject" placeholder="Subject" required>											</div>
									</div>
									<div class="col-sm-12">
										...
										<textarea  rows="3" cols="45" style="width:100%;background:url(images.png)no-repeat;border:none;" name="message"  placeholder="Message" required></textarea> </div>
									</div>
