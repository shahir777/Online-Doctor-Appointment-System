							...
							<div class="inline-teasers-wrap">
								<div class="teaser small-teaser media">
									...
									<div class="media-body media-middle">
										<h4><?php echo $data_row['contact_no'] ?></h4>
										<p class="greylinks fontsize_12"> <a href="mailto:pharmacom@example.com">manzoorhospital@gmail.com</a> </p>
									</div>
								</div>
								<div class="teaser small-teaser media">
									<div class="media-left media-middle">
									...
									<div class="media-body media-middle">
										...
										<p class="greylinks fontsize_12"> <?php echo $data_row['address'] ?> </p>
									</div>
								</div>
							</div>
						</div>
									...
									<ul class="mainmenu nav sf-menu">
										...
										<!-- <li > <a href="team.php">Team</a></li> -->
										 ...
										 <li > <a href="searchDoctor.php">Search Doctor</a></li >
										  <li > <a href="cancelappoinment.php">Appoinment Cancel</a></li>
