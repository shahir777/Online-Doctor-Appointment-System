				...
				<div class="container">
					<div class="row">
	                    ...
	                    <img src="images/logo.jpg" alt="" width="80%" float="left" style="margin-left: 0px">
								...
								<p>Hospitals are places of healing and hope, where medical professionals work tirelessly to provide care and support for those in need.</p>
						...
						<div class="col-md-3 col-sm-6">
							<div class="widget widget_text topmargin_25">
								...
								<div class="media">
									...
									<div class="media-body"><?php echo $data_row['address']; ?> </div>
								</div>
								<div class="media">
									<div class="media-left rightpadding_10"> <i class="fa fa-phone highlight" aria-hidden="true"></i> </div>
									<div class="media-body"> <?php echo $data_row['contact_no']; ?></div>
								</div>
								<div class="media">
									<div class="media-left rightpadding_10"> <i class="fa fa-pencil highlight" aria-hidden="true"></i> </div>
									<div class="media-body highlight2links"> <a href="mailto:pharmacom@example.com">manzoorhospital@gmail.com</a> </div>
								</div>
							</div>
						</div>
						<!-- <div class="col-md-3 col-sm-6">
