							...
							<form method="post" action="cancel.php">
								<div class="row">
									<div class="col-sm-6">
										...
										&nbsp  
								      <input type="number" style="border:none;" size="30" name="phone" placeholder="Phone No." required>											
								     </div>
									</div>
									...
									<div class="col-sm-6">
										...
										&nbsp 
										<input type="number" style="border:none;" size="30"  name="id" placeholder="Ticket Id" required>											
										</div>
									</div>
