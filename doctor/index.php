      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="info-box blue-bg">
            ...
            <?php 
            $select = "SELECT * FROM appoinment where `app_doctor` = '$doctor_id' AND `status` = 0";
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="info-box green-bg">
            ...
            <?php 
            $select3 = "SELECT * FROM appoinment where `app_doctor` = $doctor_id AND `status` = 2 ";

            $result3 = mysqli_query($conn,$select3);
            $rowcounte1 =mysqli_num_rows($result3);
            ?>
            <div class="count"><?php echo $rowcounte1; ?></div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="info-box dark-bg">
            ...
            <?php 
            $select2 = "SELECT * FROM appoinment where `app_doctor` = $doctor_id AND `status` = 1";
