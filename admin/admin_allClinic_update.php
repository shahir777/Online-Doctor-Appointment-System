...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
	   ...
	   <form  action="model/admin_model_allClinic_update.php" method="post" >
			...
			<!--<input type="hidden" name="image" class="form-control" value="<?php// echo $data_row['image']; ?>"><br>-->
				...
				<b>Location :</b>
				<input type="text" class="form-control" name="location" value="<?php echo $data_row['location']; ?>" hidden >			
			  ...
			  <!-- /.box-body -->
			    <div class="box-footer">
					 <a  href="admin_allClinic.php" class="btn btn-danger"> << Back</a>
