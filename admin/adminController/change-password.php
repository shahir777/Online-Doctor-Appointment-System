...
require('../comnpages/config.php');
	...
	if($_POST['cpassword']!=$_POST['newpassword'])
	{
		...
		$sql="SELECT  *  FROM tbl_logindetails WHERE user_id = '$user_id' AND  user_pass = '$oldpassword' ";
					...
					if (mysqli_num_rows($result) > 0) {
						...
						$sqlupdate="UPDATE `tbl_logindetails` SET  user_pass = '$newpassword'  WHERE user_id = '$user_id' ";
