  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
			...
			$hospitalID = $data_row['hospitalID'];
				?>
				...
				<?php
				$select = mysqli_query($conn,"SELECT * FROM clinics WHERE hospital_id = $hospitalID");
			...
			<div bgcolor="white"  style=" box-shadow:5px 3px 12px black;" >
			 <table align="center"  class="table table-striped">
				<caption> Hospital </caption>
                 <tr> <td><b>Hospital Name:</b></td><td><?php echo $row['name']; ?></td></tr>
                  <tr><td><b>Hospital Address:</b></td><td> <?php echo $row['address'];?></td></tr>
                  <tr><td><b>Hospital Location:</b></td><td> <?php echo $row['location'];?></td></tr>
