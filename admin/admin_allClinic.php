		  ...
		  <div class="row">
              ...
              <div class="row">
                  <div class="col-lg-12">
							 ...
							 if($noofrows>0)
							 {
                              ...
                              <tr>
                                ...
                                <!-- <td><image src="../images/Doctors/<?php //echo $row['image'];?>" width="100px"></td>-->
								 ...
								 <td>
						<a href="./admin_allClinic_view.php?cid=<?php echo $row['hospital_id']; ?>" 
					...
					pcid=<?php echo $row['hospital_id'];?>&action=delete"  
			...
			<a href="./admin_allClinic_update.php?xcid=<?php echo $row['hospital_id'];?>
